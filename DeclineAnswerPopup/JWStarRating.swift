...
class JWStarRating: UIControl {
    ...
    var starCount: Int = 5
    var starColor: UIColor = UIColor(red: 155.0/255.0, green: 155.0/255.0, blue: 155.0/255.0, alpha: 1)
    var starHighlightColor: UIColor = UIColor(red: 248.0/255.0, green: 231.0/255.0, blue: 28.0/255.0, alpha: 1)
